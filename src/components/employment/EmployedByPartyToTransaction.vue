<template>
  <div class="content-container image-content-type">
    <div class="image-container">
      <div class="titleText">
        {{ mainTitleVerb }} you employed by anyone involved in this transaction
        such as real estate agent, property seller, closing agent, builder, etc?
      </div>
      <inline-svg
        class="titleImage"
    ...
    setAdditionalEmploymentRelationship(bool) {
      ...
      additionals[this.employmentEditingIndex] = {
        ...
        SpecialBorrowerEmployerRelationshipIndicator:
          (bool |
            additionals[this.employmentEditingIndex].EmployedByFamilyMember) ===
          1
      };
